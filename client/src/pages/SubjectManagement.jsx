...
import subjectService from '@/services/subjectService'; // Import subject service
...
const SubjectManagement = () => {
    ...
    // Form State - Adapt for Subject
    const [name, setName] = useState("");
    const [code, setCode] = useState(""); // Add code state
    const [departmentId, setDepartmentId] = useState(""); // Add department ID state
    const [semesterId, setSemesterId] = useState(""); // Add semester ID state
                            ...
                            {subjects.length > 0 ? (
                                subjects.map((subject) => (
                                    <TableRow key={subject.id}>
                                        ...
                                        {/* Display Department and Semester Name */}
                                        ...
                                        <TableCell className="text-right">
                                            ...
                                            <Button variant="ghost" size="icon" className="text-destructive hover:text-destructive/80" onClick={() => handleDeleteSubject(subject.id)}>

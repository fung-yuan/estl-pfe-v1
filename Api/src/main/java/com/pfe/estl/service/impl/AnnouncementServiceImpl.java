                    ...
                    switch (ann.getTargetAudienceType()) {
                        ...
                        case BY_ROLE:
                            ...
                            return currentUser.getRoles() != null && 
                                   currentUser.getRoles().contains(ann.getTargetAudienceValue());
                        case BY_DEPARTMENT:
                            // Check if the announcement's target department matches the user's department
                            // Assumes targetAudienceValue stores the department name for BY_DEPARTMENT announcements
                            return currentUser.getDepartment() != null && 
                                   currentUser.getDepartment().equalsIgnoreCase(ann.getTargetAudienceValue());
                        default:
